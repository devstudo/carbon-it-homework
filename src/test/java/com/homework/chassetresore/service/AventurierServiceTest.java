...
import com.homework.chassetresore.exception.AventurierOrBordureException;
...
public class AventurierServiceTest {
    ...
    public void before() {
        ...
        carte = new Carte(bordure, Arrays.asList(tresor, tresor1), Arrays.asList(montagne1, montagne2), Arrays.asList(aventurier));
